...
The challenge is to create the Fylo Landing Page, a landing page for the Fylo website in a light theme. Users should be able to view the optimal layout for the site depending on their device's screen size and see hover states for all interactive elements on the page.
